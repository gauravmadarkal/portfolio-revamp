...
export const recommendations = [
	{
		...
		content: 'I had the pleasure of working with Gaurav for close to a year at Betsol. He is an extremely talented, pragmatic, and hard-working individual. He can develop extremely innovative and efficient solutions for complex requirements/problems. He has a “never say no attitude” and he implemented efficient solutions to ',
		userDesc: 'Software Engineer at NVIDEA'
	},
	{
		givenBy: 'Shriya Magadal',
		content: 'I have worked with Gaurav for the past year and a half and in this time I never once seen Gaurav say that something cannot be achieved. He brings an attitude of "never give up" to work. He is very hardworking and always willing to learn. He can understand the people\'s pain points and come up with solutions ',
